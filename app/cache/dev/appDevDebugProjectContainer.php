...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'enity.listener' => 'getEnity_ListenerService',
     ...
     *
     * @return \App\UserBundle\Form\RegistrationFormType A App\UserBundle\Form\RegistrationFormType instance.
     */
    protected function getAcmeUser_Registration_Form_TypeService()
    {
        return $this->services['acme_user.registration.form.type'] = new \App\UserBundle\Form\RegistrationFormType();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \App\UserBundle\Handler\AuthenticationHandler A App\UserBundle\Handler\AuthenticationHandler instance.
     */
    protected function getAuthenticationHandlerService()
    {
        return $this->services['authentication_handler'] = new \App\UserBundle\Handler\AuthenticationHandler($this->get('router'), $this->get('security.context'), $this->get('fos_user.user_manager'), $this);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate'), $this->get('enity.listener'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'advert', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $d, array('enum' => 'string'));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/App/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/App/AdvertBundle/Entity'), 2 => ($this->targetDirs[3].'/src/App/StorageBundle/Entity'), 3 => ($this->targetDirs[3].'/vendor/gedmo/doctrine-extensions/lib/Gedmo/Tree/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'App\\UserBundle\\Entity');
        $c->addDriver($b, 'App\\AdvertBundle\\Entity');
        $c->addDriver($b, 'App\\StorageBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('UserBundle' => 'App\\UserBundle\\Entity', 'AdvertBundle' => 'App\\AdvertBundle\\Entity', 'StorageBundle' => 'App\\StorageBundle\\Entity', 'GedmoTree' => 'Gedmo\\Tree\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1c73f4032953643017e390ea10e6b9280805c821d6af60b8a909de2ad208b977');
    ...
    /**
     * Gets the 'enity.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \App\CoreBundle\EventListener\EntityListener A App\CoreBundle\EventListener\EntityListener instance.
     */
    protected function getEnity_ListenerService()
    {
        return $this->services['enity.listener'] = new \App\CoreBundle\EventListener\EntityListener($this);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \App\CoreBundle\Listener\DoctrineExtensionListener A App\CoreBundle\Listener\DoctrineExtensionListener instance.
     */
    protected function getExtension_ListenerService()
    {
        $this->services['extension.listener'] = $instance = new \App\CoreBundle\Listener\DoctrineExtensionListener();
    ...
    {
        return $this->services['liip_imagine.cache.signer'] = new \Liip\ImagineBundle\Imagine\Cache\Signer('TheBigBangTheory');
    }
    ...
    {
        return $this->services['liip_imagine.filter.configuration'] = new \Liip\ImagineBundle\Imagine\Filter\FilterConfiguration(array('cache' => array('quality' => 100, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'filters' => array(), 'post_processors' => array()), 'avatar' => array('quality' => 75, 'filters' => array('thumbnail' => array('size' => array(0 => 150, 1 => 150), 'mode' => 'outbound')), 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'post_processors' => array())));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/inside/');
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($l, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username_email')), 'main', $a, $c), 2 => $n, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $e, $this->get('security.authentication.session_strategy'), $m, 'main', $f, $f, array('check_path' => 'security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '54cb7d67f22d6', $a), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $l, $e)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $m, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($this->get('http_kernel'), $m, 'security_login', false), NULL, NULL, $a));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/App/PageBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/App/UserBundle/Resources/translations/messages.ru.yml'), 'ru', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/App/AdvertBundle/Resources/translations/messages.ru.yml'), 'ru', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/App/StorageBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[2].'/Resources/translations/messages.ru.yml'), 'ru', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'BraincraftedBootstrapBundle:Form:bootstrap.html.twig', 2 => 'LiipImagineBundle:Form:form_div_layout.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        ...
        $instance->addGlobal('project', 'Advert');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/App/PageBundle/Resources/views'), 'Page');
        $instance->addPath(($this->targetDirs[3].'/src/App/CoreBundle/Resources/views'), 'Core');
        $instance->addPath(($this->targetDirs[3].'/src/App/UserBundle/Resources/views'), 'User');
        $instance->addPath(($this->targetDirs[3].'/src/App/AdvertBundle/Resources/views'), 'Advert');
        $instance->addPath(($this->targetDirs[3].'/src/App/StorageBundle/Resources/views'), 'Storage');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('TheBigBangTheory');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AdvertBundle' => 'App\\AdvertBundle\\AdvertBundle',
                'StorageBundle' => 'App\\StorageBundle\\StorageBundle',
            ...
            'kernel.secret' => 'TheBigBangTheory',
