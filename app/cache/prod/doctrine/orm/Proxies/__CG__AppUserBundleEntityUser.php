...
class User extends \App\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'App\\UserBundle\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'App\\UserBundle\\Entity\\User' . "\0" . 'lastName', '' . "\0" . 'App\\UserBundle\\Entity\\User' . "\0" . 'gender', '' . "\0" . 'App\\UserBundle\\Entity\\User' . "\0" . 'adverts', '' . "\0" . 'App\\UserBundle\\Entity\\User' . "\0" . 'advertBookmarks', 'image', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
    ...
    public function addAdvertBookmark(\App\AdvertBundle\Entity\Advert $advertBookmarks)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addAdvertBookmark', array($advertBookmarks));

        return parent::addAdvertBookmark($advertBookmarks);
    }
    ...
    public function removeAdvertBookmark(\App\AdvertBundle\Entity\Advert $advertBookmarks)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeAdvertBookmark', array($advertBookmarks));

        return parent::removeAdvertBookmark($advertBookmarks);
    }
    ...
    public function getAdvertBookmarks()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAdvertBookmarks', array());

        return parent::getAdvertBookmarks();
    }
