...
',
  ...
  array (
    ...
    'Ad has been added to the bookmark list' => 'Обявление добавленно в закладки.',
    'Ad has been deleted from the bookmark list' => 'Обявление удаленно из закладок.',
    'Continue prepare' => 'Продолжить заполнение.',
    'Price must be at least {{ limit }}' => 'Цена должна бить болшье {{ limit }}.',
    'advert.one' => 'Обявление',
    'advert.many' => 'Обявления',
    'advert.create_new' => 'Добавить обявление',
    'advert.title' => 'Заголовок',
    'advert.category' => 'Раздел',
    'advert.price' => 'Стоимость',
    'advert.content' => 'Описание',
    'category.one' => 'Категория',
    'category.many' => 'Категории',
    'settings' => 'Настройки',
    'I have read and accept the %general_terms_and_conditions%.' => 'Я прочитал и соглашаюсь с %general_terms_and_conditions%.',
    'General Terms and Conditions' => 'договором оферты',
    'Read the General Terms and Conditions' => 'Прочитать договор оферты',
    'Calculating the cost of the agreement' => 'Рассчет стоимости продукта',
    'Save' => 'Сохранить',
    'status' => 'Статус',
    'signed' => 'Подписан',
    'paid' => 'Оплачен',
    ...
    'Category of advert' => 'Категория объявления',
    'Please check form' => 'Пожалуйста, проверьте форму',
    'project.name' => 'Advert',
    'project.homepage' => 'Главная',
    'property.name' => 'Название',
    'property.full_name' => 'Имя',
    'property.is_enabled' => 'Активен',
    'property.created_at' => 'Дата создания',
    'property.updated_at' => 'Дата изменения',
    'property.enabled' => 'Активный?',
    'property.description' => 'Описание',
    'property.new_password' => 'Новый пароль',
    'property.confirm_password' => 'Повторите пароль',
    'property.father_name' => 'Отчество',
    'property.last_login' => 'Последний вход',
    'property.code' => 'Код',
    'property.duration' => 'Срок',
    'property.unit' => 'Единицы измерения',
    'property.day' => 'День',
    'property.month' => 'Месяц',
    'property.year' => 'Год',
    'property.percentage' => 'Процент',
    'property.sum_insured' => 'Страховая сумма',
    'property.min' => 'Минимальное значение',
    'property.max' => 'Максимальное значение',
    'property.passport_series' => 'Серия паспорта',
    'property.passport_number' => 'Номер паспорта',
    'property.inn' => 'Идентификационный код',
    'property.passport' => 'Паспорт',
    'property.date_from' => 'Действительный с',
    'property.date_till' => 'Действительный по',
    'property.passport_issued_by' => 'Кем выпущен',
    'property.passport_issued_at' => 'Когда выпущен',
    'property.attachments' => 'Прикрепленные файлы',
    'property.payment_system' => 'Платежная система',
    'property.phone_number' => 'Номер телефона',
    'property.cost' => 'Страховая премия',
    'action.edit' => 'Изменить',
    'action.create' => 'Добавить',
    'action.update' => 'Изменить',
    'action.select' => 'Выбрать',
    'action.delete' => 'Удалить',
    'action.logout' => 'Выйти',
    'action.send' => 'Отправить',
    'action.continue' => 'Продолжить',
    'action.show' => 'Просмотр',
    'action.back' => 'Вернуться',
    'action.copy' => 'Копировать',
    'action.go_to_homepage' => 'Перейти на главную',
    'form.validate.error' => 'Проверьте форму',
    'form.validate.match_password' => 'Пароли должны совпадать',
    'form.validate.wrong_range' => 'Неправельный диапазон',
    'form.validate.range_already_use' => 'Диапазон уже используеться',
    'form.save.success' => 'Запись успешно сохраненна',
    'form.save.error' => 'При сохранении прозошла непредвиденая ошибка',
    'form.remove.success' => 'Удаление выполненно успешно',
    'form.remove.error' => 'При удалении произошла ошибка',
    'tabs.data' => 'Данные',
    'tabs.step' => 'Шаг',
    'security.login.submit' => 'Вход',
    'security.registration.submin' => 'Зарегистрироваться',
    'email.letter.greeting' => 'Уважаемый',
    'email.letter.thanks' => 'С уважением',
    'email.letter.sign.description' => 'Вы начали процедуру оформления договора. Чтобы продолжить скопируйте код ниже и вставьте его в поле для подписания.',
    'label.settings' => 'Настройки',
    'label.edit' => 'Изминение',
  ),
));
